...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ApiReuslt<T>);
}
...
/// @nodoc
class $ApiReusltCopyWith<T,$Res>  {
$ApiReusltCopyWith(ApiReuslt<T> _, $Res Function(ApiReuslt<T>) __);
}


/// Adds pattern-matching-related methods to [ApiReuslt].
extension ApiReusltPatterns<T> on ApiReuslt<T> {
...
class Success<T> implements ApiReuslt<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of ApiReuslt
...
@override
String toString() {
  return 'ApiReuslt<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ApiReusltCopyWith<T, $Res> {
...
class Failure<T> implements ApiReuslt<T> {
...
@override
String toString() {
  return 'ApiReuslt<$T>.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $ApiReusltCopyWith<T, $Res> {
